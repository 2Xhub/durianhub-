...
ImageButton1.Image = "rbxassetid://16513855063"
...
function Update:Window(text,logo,keybind)
	...
	Logo.Image = "rbxassetid://16513855063"
    ...
    function main:AddToggle(TogInfo ,default, callback)
        ...
        ImageLabel.Image = "rbxassetid://16513855063"
...
local Library = Update:Window("KuroX Hub","",Enum.KeyCode.RightControl);
...
H:AddLabel("Mobile:")
H:AddLabel("Fluxus, DeltaX, Codex, TriGon")
H:AddLabel("Flodded V")

H:AddSeperator("Developer")

H:AddLabel("Code By LeThanhDat")

H:AddLabel("KuroX Hub Discord")
H:AddLabel("https://discord.gg/rUKWhEJHf2")
H:AddLabel("Discord: Kuro Cute")
 

H:AddButton("Youtube KuroX Hub",function()
setclipboard("Soon...")
game.StarterGui:SetCore("SendNotification", {
      Icon = "rbxassetid://16513855063";
      Title = "KuroX Hub", 
      Text = "Copied";
})
end)
